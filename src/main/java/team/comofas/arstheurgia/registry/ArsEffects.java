...
public class ArsEffects {
    public static final ATEffect PAZUZU_BLESSING = new ATEffect(StatusEffectType.NEUTRAL, 0xFFFFFF);
    public static final ATEffect LAMASHTU_BLESSING = new ATEffect(StatusEffectType.NEUTRAL, 0xFFFFFF);
