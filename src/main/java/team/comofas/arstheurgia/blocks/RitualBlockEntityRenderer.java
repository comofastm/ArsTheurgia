...
public class RitualBlockEntityRenderer extends BlockEntityRenderer<RitualBlockEntity> {
    public RitualBlockEntityRenderer(BlockEntityRenderDispatcher dispatcher) {
        super(dispatcher);
    }
